...
<head>
	...
	<title>Mushalla Al-Ikhlas</title>
	<link rel="icon" href="dist/img/admin.png">
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_km" class="nav-link">Rekap Kas Mushalla</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_ks" class="nav-link">Rekap Infaq donatur</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_ks" class="nav-link">Rekap Pembangunan Mushalla</a>
				</li> -->
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="http://localhost:8080/kas_masjid/" class="brand-link">
				<img src="dist/img/blank.png" alt="AdminLTE Logo" class="brand-image" style="opacity: -8">
				<span class="brand-text font-weight-light">Mushalla Al-Ikhlas</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="dist/img/admin3.png" class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
						<a href="http://localhost:8080/kas_masjid/" class="d-block">
							<!-- <?php echo $data_nama; ?> -->
						</a>
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						?>
							<li class="nav-item">
								<a href="http://localhost:8080/kas_masjid/" class="nav-link">
					...
					if (isset($_GET['page'])) {
						...
						switch ($hal) {
							...
							case 'rekap_km':
								...
								//pembangunan
							case 'pembangunan':
								include "bendahara/pembangunan/pembang.php";
								break;
							case 'add_pembang':
								include "bendahara/pembangunan/add_pembang.php";
								break;
							case 'edit_pembang':
								include "bendahara/pembangunan/edit_pembang.php";
								break;

								//pesan
							case 'pesan':
								include "bendahara/pesan/message.php";
								break;
							case 'm_del':
								include "bendahara/pesan/delete.php";
								break;
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Mushalla Al-Ikhlas Perum Graha Namarina tahap 2
			</div>
			Copyright &copy;
	...
	<script type="text/javascript" src="../kas_masjid/jquery.idle-master/jquery.idle.js"></script>
	<script>
		$(document).idle({
			onIdle: function() {
				window.location = "http://localhost:8080/kas_masjid/logout.php";
			},
			idle: 300000
		});
	</script>
